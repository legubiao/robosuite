...
class Robotiq85AdaptiveGripperBase(GripperModel):
    """
    6-DoF Robotiq gripper.
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/robotiq_gripper_85_adaptive.xml"), idn=idn)
...
class Robotiq85AdaptiveGripper(Robotiq85AdaptiveGripperBase):
    """
    1-DoF variant of RobotiqGripperBase.
    """
