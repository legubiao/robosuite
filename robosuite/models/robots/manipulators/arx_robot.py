...
class ArxX5(ManipulatorModel):
    """
    Arx X5 is a single-arm robot, typically for customizable mounting on quadruped.
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/arx_x5/robot.xml"), idn=idn)
...
class ArxX5Dual(ManipulatorModel):
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/arx_x5/dual_robot.xml"), idn=idn)
...
class ArxX7sArms(ManipulatorModel):

    arms = ["right", "left"]

    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/arx_x7s/dual_robot.xml"), idn=idn)
